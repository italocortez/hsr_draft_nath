...
export function CostTables({ characters, lightcones }: CostTablesProps) {
    ...
    const sortedAndFilteredCharacters = useMemo((): Character[] => {
        ...
        return sorted;
    }, [characters, characterSelectedRoles, characterSelectedPaths, characterSelectedElements, characterSearchTerm, characterSort, selectedRuleSet]);
    ...
    const sortedAndFilteredLightcones = useMemo((): Lightcone[] => {
        ...
        if (lightconeSelectedPaths.length > 0) {
            filtered = filtered.filter(char => lightconeSelectedPaths.includes(char.path));
        }
  ...
  return (
    <div className="CostTables">
        ...
        <div className="table Box">
            {/* Header */}
            <div className="header space-y-4 mb-4">
                {/* Title */}
