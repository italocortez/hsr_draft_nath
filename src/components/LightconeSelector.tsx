...
const lightconeDimensions: Record<string, { width: string; bottom: string; left: string }> = {
    ...
    'arrows': { width: '', bottom: '', left: '' },
    'baptismofpurethought': { width: '', bottom: '', left: '' },
    'beforedawn': { width: '', bottom: '', left: '' },
    'beforethetutorialmissionstarts': { width: '', bottom: '', left: '' },
    'boundlesschoreo': { width: '', bottom: '', left: '' },
    'brighterthanthesun': { width: '', bottom: '', left: '' },
    'butthebattleisntover': { width: '', bottom: '', left: '' },
    'carvethemoonweavetheclouds': { width: '', bottom: '', left: '' },
    'chorus': { width: '', bottom: '', left: '' },
    'collapsingsky': { width: '', bottom: '', left: '' },
    'concertfortwo': { width: '', bottom: '', left: '' },
    'cornucopia': { width: '', bottom: '', left: '' },
    'cruisinginthestellarsea': { width: '', bottom: '', left: '' },
    'danceatsunset': { width: '', bottom: '', left: '' },
    'dancedancedance': { width: '', bottom: '', left: '' },
    'dartingarrow': { width: '', bottom: '', left: '' },
    'databank': { width: '', bottom: '', left: '' },
    'dayoneofmynewlife': { width: '', bottom: '', left: '' },
    'defense': { width: '', bottom: '', left: '' },
    'destinysthreadsforewoven': { width: '', bottom: '', left: '' },
    'dreamsmontage': { width: '', bottom: '', left: '' },
    'dreamvilleadventure': { width: '', bottom: '', left: '' },
    'earthlyescapade': { width: '', bottom: '', left: '' },
    'echoesofthecoffin': { width: '', bottom: '', left: '' },
    'epochetchedingoldenblood': { width: '', bottom: '', left: '' },
    'eternalcalculus': { width: '', bottom: '', left: '' },
    'eyesoftheprey': { width: '', bottom: '', left: '' },
    'fermata': { width: '', bottom: '', left: '' },
    'finalvictor': { width: '', bottom: '', left: '' },
    'finefruit': { width: '', bottom: '', left: '' },
    'flameofbloodblazemypath': { width: '', bottom: '', left: '' },
    'flamesafar': { width: '', bottom: '', left: '' },
    'flowingnightglow': { width: '', bottom: '', left: '' },
    'flyintoapinktomorrow': { width: '', bottom: '', left: '' },
    'fortomorrowsjourney': { width: '', bottom: '', left: '' },
    'geniusesgreetings': { width: '', bottom: '', left: '' },
    'geniusesrepose': { width: '', bottom: '', left: '' },
    'goodnightandsleepwell': { width: '', bottom: '', left: '' },
    'heyoverhere': { width: '', bottom: '', left: '' },
    'hiddenshadow': { width: '', bottom: '', left: '' },
    'holidaythermaeescapade': { width: '', bottom: '', left: '' },
    'ishallbemyownsword': { width: '', bottom: '', left: '' },
    'iventureforthtohunt': { width: '', bottom: '', left: '' },
    'iftimewereaflower': { width: '', bottom: '', left: '' },
    'inpursuitofthewind': { width: '', bottom: '', left: '' },
    'inthenameoftheworld': { width: '', bottom: '', left: '' },
    'inthenight': { width: '', bottom: '', left: '' },
    'incessantrain': { width: '', bottom: '', left: '' },
    'indeliblepromise': { width: '', bottom: '', left: '' },
    'inherentlyunjustdestiny': { width: '', bottom: '', left: '' },
    'intotheunreachableveil': { width: '', bottom: '', left: '' },
    'itsshowtime': { width: '', bottom: '', left: '' },
    'journeyforeverpeaceful': { width: '', bottom: '', left: '' },
    'landauschoice': { width: '', bottom: '', left: '' },
    'liesdanceonthebreeze': { width: '', bottom: '', left: '' },
    'lifeshouldbecasttoflames': { width: '', bottom: '', left: '' },
    'longmayrainbowsadornthesky': { width: '', bottom: '', left: '' },
    'longroadleadshome': { width: '', bottom: '', left: '' },
    'loop': { width: '', bottom: '', left: '' },
    'makefarewellsmorebeautiful': { width: '', bottom: '', left: '' },
    'maketheworldclamor': { width: '', bottom: '', left: '' },
    'mediation': { width: '', bottom: '', left: '' },
    'memoriesofthepast': { width: '', bottom: '', left: '' },
    'memoryscurtainneverfalls': { width: '', bottom: '', left: '' },
    'meshingcogs': { width: '', bottom: '', left: '' },
    'momentofvictory': { width: '', bottom: '', left: '' },
    'multiplication': { width: '', bottom: '', left: '' },
    'mutualdemise': { width: '', bottom: '', left: '' },
    'neverforgetherflame': { width: '', bottom: '', left: '' },
    'nightoffright': { width: '', bottom: '', left: '' },
    'nightonthemilkyway': { width: '', bottom: '', left: '' },
    'ninjarecordsoundhunt': { width: '', bottom: '', left: '' },
    'ninjutsuinscriptiondazzlingevilbreaker': { width: '', bottom: '', left: '' },
    'nowheretorun': { width: '', bottom: '', left: '' },
    'onthefallofanaeon': { width: '', bottom: '', left: '' },
    'onlysilenceremains': { width: '', bottom: '', left: '' },
    'passkey': { width: '', bottom: '', left: '' },
    'pastandfuture': { width: '', bottom: '', left: '' },
    'pastselfinmirror': { width: '', bottom: '', left: '' },
    'patienceisallyouneed': { width: '', bottom: '', left: '' },
    'perfecttiming': { width: '', bottom: '', left: '' },
    'pioneering': { width: '', bottom: '', left: '' },
    'planetaryrendezvous': { width: '', bottom: '', left: '' },
    'poisedtobloom': { width: '', bottom: '', left: '' },
    'postopconversation': { width: '', bottom: '', left: '' },
    'quidproquo': { width: '', bottom: '', left: '' },
    'reforgedremembrance': { width: '', bottom: '', left: '' },
    'reminiscence': { width: '', bottom: '', left: '' },
    'resolutionshinesaspearlsofsweat': { width: '', bottom: '', left: '' },
    'returntodarkness': { width: '', bottom: '', left: '' },
    ...
    'sharedfeeling': { width: '', bottom: '', left: '' },
    'shatteredhome': { width: '', bottom: '', left: '' },
    'shealreadyshuthereyes': { width: '', bottom: '', left: '' },
    'sleeplikethedead': { width: '', bottom: '', left: '' },
    'solitaryhealing': { width: '', bottom: '', left: '' },
    'somethingirreplaceable': { width: '', bottom: '', left: '' },
    'subscribeformore': { width: '', bottom: '', left: '' },
    'sweatnowcryless': { width: '', bottom: '', left: '' },
    'swordplay': { width: '', bottom: '', left: '' },
    'textureofmemories': { width: '', bottom: '', left: '' },
    'thebirthoftheself': { width: '', bottom: '', left: '' },
    'thedaythecosmosfell': { width: '', bottom: '', left: '' },
    'theflowerremembers': { width: '', bottom: '', left: '' },
    'theforevervictual': { width: '', bottom: '', left: '' },
    'thegreatcosmicenterprise': { width: '', bottom: '', left: '' },
    'thehellwhereidealsburn': { width: '', bottom: '', left: '' },
    'themoleswelcomeyou': { width: '', bottom: '', left: '' },
    'theseriousnessofbreakfast': { width: '', bottom: '', left: '' },
    'thestorysnextpage': { width: '', bottom: '', left: '' },
    'theunreachableside': { width: '', bottom: '', left: '' },
    'thisloveforever': { width: '', bottom: '', left: '' },
    'thisisme': { width: '', bottom: '', left: '' },
    'thosemanysprings': { width: '', bottom: '', left: '' },
    'thoughworldsapart': { width: '', bottom: '', left: '' },
    'thusburnsthedawn': { width: '', bottom: '', left: '' },
    'timewaitsfornoone': { width: '', bottom: '', left: '' },
    'timewovenintogold': { width: '', bottom: '', left: '' },
    'toevernightsstars': { width: '', bottom: '', left: '' },
    'todayisanotherpeacefulday': { width: '', bottom: '', left: '' },
    'trendoftheuniversalmarket': { width: '', bottom: '', left: '' },
    'underthebluesky': { width: '', bottom: '', left: '' },
    'untotomorrowsmorrow': { width: '', bottom: '', left: '' },
    'victoryinablink': { width: '', bottom: '', left: '' },
    'void': { width: '', bottom: '', left: '' },
    'warmthshortenscoldnights': { width: '', bottom: '', left: '' },
    'wearewildfire': { width: '', bottom: '', left: '' },
    'wewillmeetagain': { width: '', bottom: '', left: '' },
    'whatisreal': { width: '', bottom: '', left: '' },
    'whereaboutsshoulddreamsrest': { width: '', bottom: '', left: '' },
    'whydoestheoceansing': { width: '', bottom: '', left: '' },
    'woofwalktime': { width: '', bottom: '', left: '' },
    'worrisomeblissful': { width: '', bottom: '', left: '' },
    'yethopeispriceless': { width: '', bottom: '', left: '' },
};
