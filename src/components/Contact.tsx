    ...
    <div className="bg-gray-800 rounded-lg p-8 border border-gray-700 max-w-2xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          {/* Discord Username */}
          <div className="bg-gray-700 rounded-lg p-4 border border-gray-600">
            <h3 className="text-white font-semibold mb-2">Discord Username</h3>
            <div className="flex items-center gap-3">
              <code className="bg-gray-800 text-cyan-400 px-3 py-2 rounded font-mono text-sm border border-gray-600">
                nathyron
              </code>
              <button
                onClick={handleCopyUsername}
                className="px-3 py-2 bg-cyan-600 hover:bg-cyan-700 text-white text-sm rounded transition-colors flex items-center gap-2"
              >
                {copied ? (
                  <>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
